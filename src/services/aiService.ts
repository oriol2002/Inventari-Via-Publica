...
export const aiService = {
  async generateStatisticalReport(crossings: PedestrianCrossing[], city: string): Promise<string> {
    if (!ai) {
      console.warn('Gemini API key not configured, skipping AI report generation');
      return "L'informe automàtic requereix configurar la clau API de Gemini. Per ara, revisa les estadístiques manuals.";
    }
